...
using Exercicio_Aula46.Domain;

namespace Exercicio_Aula46
{
    class Tela
    {
        // Classe por conter operações que interagem com o usuário no modo console.
        ...
        public static void cadastrarPedido()
        {
            ...
            for (int i = 0; i < N; i++)
            {
                ...
                if (pos == -1)
                {
                    throw new ModelException("Codigo de produto não encontrado: " + codProduto);
                }
